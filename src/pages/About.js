...
import StartsComponent from "../components/core/AboutPage/StartsComponent";
    ...
    return (
        ...
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          ...
          <div className="absolute bottom-0 left-[50%] grid w-[100%] translate-x-[-50%] translate-y-[30%] grid-cols-3 gap-3 lg:gap-5">
            ...
            <section> 
                <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-center gap-10 text-richblack-400 ">
                    ...
                    <div className="flex flex-col items-center gap-10 lg:flex-row justify-between ">    
                        ...
                        <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                            ...
                            <p className="text-base font-medium text-richblack-300 lg:w-[95%]">
                                 ...
                                 the need for accessible, flexible, and high-quality learning opportunities in a rapidly evolving
                                 digital world. 
                            </p>
                    ...
                    loop
                    autoPlay
                    className=" shadow-[0_0_20px_0] shadow-[#FC6767] relative max-w-[35rem]  " 
                    >
                    ...
                    <div className=" flex flex-col items-center lg:gap-10 lg:flex-row justify-between">
                        ...
                        <div className="my-24 flex lg:w-[40%] flex-col gap-10 ">
                           ...
                           {/* right box */}
                           <div className="my-24 flex lg:w-[40%] flex-col gap-10 ">
                                <h1 className="bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] text-transparent text-4xl  bg-clip-text font-semibold lg:w-[70%] " >
                                     Our Mission
                                </h1>
                                ...
                                <p className="text-base font-medium text-richblack-300 lg:w-[95%] " > 
                                    ...
                                    We believe that knowledge thrives in an environment of sharing and dialogue, and we
                                    foster this spirit of collaboration through forums, live sessions, and networking 
                                    opportunities. </p>
                           </div>
            ...
            {/* Section - 4 */}
            <StartsComponent/>
            <section className="mx-auto mt-20 flex flex-col w-11/12 max-w-maxContent gap-10 text-white  ">
            <LearningGrid />
            <ContactFormSection />
            </section>
            ...
            <div className="relative mx-auto my-20 flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 bg-richblack-900 text-white ">
                <h1 className="text-center text-4xl font-semibold mt-8 items-cente justify-center mx-auto ">
